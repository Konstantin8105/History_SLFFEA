...
void tsdisp_vectors0(int displaylistnum, BOUND bc, double *coord0)
{
...
void tsforce_vectors0(int displaylistnum, BOUND bc, double *coord0,
	XYZF *force_vec )
{
...
void tsdisp_vectors(BOUND bc, double *coord)
{
...
void tsforce_vectors(BOUND bc, double *coord, XYZF *force_vec )
{
