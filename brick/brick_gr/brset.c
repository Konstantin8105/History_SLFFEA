/*
    ...
    determined in brparameters for the FEM GUI for brick elements.
...
int brset( BOUND bc, int *connecter, double *coord, double *force,
	XYZF *force_vec0, SDIM *strain_node, ISTRAIN *strain_color,
