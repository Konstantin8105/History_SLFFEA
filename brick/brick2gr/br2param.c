...
int br2parameter( double *coord, double *Q, SDIM *strain_node, SDIM *stress_node,
	double *T, double *U)
{
        int i, j, check;
...
/* Print the above data in the file "br2view.dat" */
	...
	fprintf( brdata,"\n");
	fprintf( brdata,"Temperature            %5d %5d   %14.6e %14.6e\n", node_T_min,
		node_T_max, min_T, max_T);
	fprintf( brdata,"heat Q                 %5d %5d   %14.6e %14.6e\n", node_Q_min,
