/* This program calculates the eigenvalues of the matrix system:
   ...
   a tetrahedral element.  Note that implicit in this algorithm is the assumption
...
int teMassPassemble(int *, double *, int *, double *, MATL *, double *, double *);

int QR_check( double *, double *, double *, int, int );

int teLanczos(double *K, BOUND bc, int *connect, double *coord, EIGEN *eigen, 
...
*/
		...
		check = teConjGrad( K, bc, connect, coord, el_matl, fdum_vector_in,
