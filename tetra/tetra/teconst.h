/*
    This is the include file "teconst.h" for the finite element progam 
    which uses tetrahedral elements.  It is set up for all the different
    tetrahedral elements including the thermal.
...
/*    Below is the additional list of constants for the tetrahedral element br2
...
/*
      Below is a list of variables for the tetrahedral elements br and nbr.  
  ...
  connect      (0-7)  connectivity array for 3-D tetrahedral elements
...
/*
      Below is the additional list of variables for the tetrahedral element br2
      which has thermal properties.  
