...
{
/*
    This subroutine multiplies A with the rotation matrix. 
    It is streamlined so that only the non-zero terms of
...
{
/*
    This subroutine multiplies the rotation matrix
    with the A matrix for a 3D beam.  It is streamlined so that
    only the non-zero terms of the rotation matix are multiplied.
