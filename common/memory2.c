/*
    This utility function allocates the memory for 3-D constant strain
    elements(an example of a non-constant strain element is the
    brick) for the finite element program.
...
int Memory2( double **mem_double, int sofmf, int **mem_int, int sofmi,
...
int ReGetMemory2( double **mem_double, int sofmf, int **mem_int, int sofmi,
	MATL **matl, int nmat, XYZI **mem_XYZI, int sofmXYZI, SDIM **strain,
	SDIM **strain_node, SDIM **stress, SDIM **stress_node,
	int sofmSDIM, int sofmSDIM_node )
{
