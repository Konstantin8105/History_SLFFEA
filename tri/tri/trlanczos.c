...
int trMassPassemble(int *, double *, int *, double *, double *, MATL *,
	double *, double *);

int QR_check( double *, double *, double *, int, int );

int trLanczos(double *K, BOUND bc, int *connect, double *coord, EIGEN *eigen,
	int *el_matl, int *id, int *idiag, double *K_diag, double *local_xyz,
...
*/
	    ...
	    check = trMassPassemble(connect, coord, el_matl, local_xyz,
