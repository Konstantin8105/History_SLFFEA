/* This progam extrudes a triangle mesh in the z direction
   to create wedge elements.

     SLFFEA source file
     Version:  1.2
     Copyright (C) 2001  San Le
...
int main()
{
	...
	int *connect, nlayers, numel, numnp, nmat, npel;
	...
	fgets( buf, BUFSIZ, o2 );
	printf( "   numel numnp nmat nmode This is for a 6 node wedge\n");
