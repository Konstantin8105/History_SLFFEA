/*
    This program draws the drag down menus.  It works with a triangle FEM code.
...
int trset(BOUND , int *, double *, XYF *, STRAIN *, ISTRAIN *, STRESS *,
        ISTRESS *, double *, int *);

void trReGetparameter( void);

void trMenuSelect(int value)
{
	int check;
