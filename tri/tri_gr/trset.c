/*
    ...
    determined in trparameters for the FEM GUI for triangle elements.
...
int trset( BOUND bc, int *connecter, double *force, XYF *force_vec0,
	STRAIN *strain_node, ISTRAIN *strain_color, STRESS *stress_node,
