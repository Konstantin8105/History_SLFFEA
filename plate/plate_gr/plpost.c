...
int plMemory_gr( ICURVATURE **, IMOMENT **, ISTRAIN **, ISTRESS **, NORM **,
        int, int );
...
double Uz_div[boxnumber+1], Uphi_x_div[boxnumber+1], Uphi_y_div[boxnumber+1];
...
int main(int argc, char** argv)
{
	...
	int  sofmi, sofmf, sofmSTRESS, sofmISTRESS, sofmSTRAIN,
		sofmZPhiI, sofmZPhiF, sofmSDIM, sofmNORM, ptr_inc;
