...
{
/*
This is for a 4 node plate.

                  Last Update 9/25/06
*/

	int i, i2, j, k, dof_el[neqel24], sdof_el[npel4*nsd], ii, check, counter, node;
	int l,m,n;
	int c0,c1,c2,c3;
	int matl_number, node_number;
	int After_gr_flag = 0, Before_gr_flag = 0,
		After_element_draw_flag = 1, Before_element_draw_flag = 1;
	double coord_el[npel4*3], coord0_el[npel4*3], fpointx, fpointy, fpointz;
...
/* Calculate element degrees of freedom */
		    ...
		    node = *(connecter+npel4*k+j);
		    *(sdof_el+nsd*j) = nsd*node;
		    *(sdof_el+nsd*j+1) = nsd*node+1;
		    *(sdof_el+nsd*j+2) = nsd*node+2;

		    *(dof_el+ndof6*j) = ndof6*node;
		    *(dof_el+ndof6*j+1) = ndof6*node+1;
		    *(dof_el+ndof6*j+2) = ndof6*node+2;
		    *(dof_el+ndof6*j+3) = ndof6*node+3;
		    *(dof_el+ndof6*j+4) = ndof6*node+4;
		    *(dof_el+ndof6*j+5) = ndof6*node+5;
...
/* Calculate element material number */
		...
		switch (color_choice) {
			...
			c2 = curve_color[k].pt[2].xx;
			c3 = curve_color[k].pt[3].xx;
		    break;
		    case 42:
			c0 = curve_color[k].pt[0].yy;
			c1 = curve_color[k].pt[1].yy;
			c2 = curve_color[k].pt[2].yy;
			c3 = curve_color[k].pt[3].yy;
		    break;
		    case 44:
			c0 = curve_color[k].pt[0].xy;
			c1 = curve_color[k].pt[1].xy;
			c2 = curve_color[k].pt[2].xy;
			c3 = curve_color[k].pt[3].xy;
		    break;
		    case 47:
			c0 = curve_color[k].pt[0].I;
			c1 = curve_color[k].pt[1].I;
			c2 = curve_color[k].pt[2].I;
			c3 = curve_color[k].pt[3].I;
		    break;
		    case 48:
			c0 = curve_color[k].pt[0].II;
			c1 = curve_color[k].pt[1].II;
			c2 = curve_color[k].pt[2].II;
			c3 = curve_color[k].pt[3].II;
		    break;
		    case 1:
			...
			c2 = moment_color[k].pt[2].xx;
			c3 = moment_color[k].pt[3].xx;
		    break;
		    case 51:
			c0 = moment_color[k].pt[0].yy;
			c1 = moment_color[k].pt[1].yy;
			c2 = moment_color[k].pt[2].yy;
			c3 = moment_color[k].pt[3].yy;
		    break;
		    case 53:
			c0 = moment_color[k].pt[0].xy;
			c1 = moment_color[k].pt[1].xy;
			c2 = moment_color[k].pt[2].xy;
			c3 = moment_color[k].pt[3].xy;
		    break;
		    case 56:
			c0 = moment_color[k].pt[0].I;
			c1 = moment_color[k].pt[1].I;
			c2 = moment_color[k].pt[2].I;
			c3 = moment_color[k].pt[3].I;
		    break;
		    case 57:
			c0 = moment_color[k].pt[0].II;
			c1 = moment_color[k].pt[1].II;
			c2 = moment_color[k].pt[2].II;
			c3 = moment_color[k].pt[3].II;
		    break;
		    case 10:
		    ...
		    break;
		    case 19:
			c0 = *(U_color + *(dof_el + ndof6*0));
			c1 = *(U_color + *(dof_el + ndof6*1));
			c2 = *(U_color + *(dof_el + ndof6*2));
			c3 = *(U_color + *(dof_el + ndof6*3));
		    break;
		    case 20:
			c0 = *(U_color + *(dof_el + ndof6*0 + 1));
			c1 = *(U_color + *(dof_el + ndof6*1 + 1));
			c2 = *(U_color + *(dof_el + ndof6*2 + 1));
			c3 = *(U_color + *(dof_el + ndof6*3 + 1));
		    break;
		    case 21:
			c0 = *(U_color + *(dof_el + ndof6*0 + 2));
			c1 = *(U_color + *(dof_el + ndof6*1 + 2));
			c2 = *(U_color + *(dof_el + ndof6*2 + 2));
			c3 = *(U_color + *(dof_el + ndof6*3 + 2));
		    break;
		    case 22:
			c0 = *(U_color + *(dof_el + ndof6*0 + 3));
			c1 = *(U_color + *(dof_el + ndof6*1 + 3));
			c2 = *(U_color + *(dof_el + ndof6*2 + 3));
			c3 = *(U_color + *(dof_el + ndof6*3 + 3));
		    break;
		    case 23:
			c0 = *(U_color + *(dof_el + ndof6*0 + 4));
			c1 = *(U_color + *(dof_el + ndof6*1 + 4));
			c2 = *(U_color + *(dof_el + ndof6*2 + 4));
			c3 = *(U_color + *(dof_el + ndof6*3 + 4));
		    break;
		    case 24:
			c0 = *(U_color + *(dof_el + ndof6*0 + 5));
			c1 = *(U_color + *(dof_el + ndof6*1 + 5));
			c2 = *(U_color + *(dof_el + ndof6*2 + 5));
			c3 = *(U_color + *(dof_el + ndof6*3 + 5));
		    break;
		    case 30:
			c0 = 0;
			c1 = 0;
...
{
/*
This is for a 3 node plate.

                  Last Update 9/25/06
*/
	int i, i2, j, k, dof_el[neqel18], sdof_el[npel3*nsd], ii, check, counter, node;
	int l,m,n;
	int c0,c1,c2;
	int matl_number, node_number;
	int After_gr_flag = 0, Before_gr_flag = 0,
		After_element_draw_flag = 1, Before_element_draw_flag = 1;
	double coord_el[npel3*3], coord0_el[npel3*3], fpointx, fpointy, fpointz;
	GLfloat d1[3], d2[3], norm_temp[3];
