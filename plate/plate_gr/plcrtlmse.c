...
extern int ControlDiv_y[plrowdim + 2], ControlDiv_x[plrowdim + 2];
extern int boxMove_x, boxMove_y, boxTextMove_x, textMove_x, textMove_y[plrowdim+2];
...
extern int Color_flag[plrowdim];
...
void plControlMouse(int button, int state, int x, int y)
{
...
/* Principal Moments I*/
			...
			if ( y >= ControlDiv_y[42] )
			{
/* Principal Moments II*/
				angle_flag = 0;
				disp_flag = 0;
				color_choice = 57;
			}
			if ( y >= ControlDiv_y[45] )
			{
/* Principal Stress I*/
				angle_flag = 0;
				disp_flag = 0;
...
/* Principal Stress II*/
			...
			if ( y >= ControlDiv_y[47] )
			{
/* Principal Stress III*/
				angle_flag = 0;
				disp_flag = 0;
				color_choice = 18;
			}
...
/* Angle Z*/
	...
	switch (color_choice) {
		...
		break;
		case 44:
			strncpy(BoxText, "curve XY", 8);
			Color_flag[31] = 1;
			strain_flag = 1;
			stress_flag = 0;
			sprintf( BoxData[0], "%10.3e ", curve_div[8].xy);
			sprintf( BoxData[2], "%10.3e ", curve_div[7].xy);
			sprintf( BoxData[4], "%10.3e ", curve_div[6].xy);
			sprintf( BoxData[6], "%10.3e ", curve_div[5].xy);
			sprintf( BoxData[8], "%10.3e ", curve_div[4].xy);
			sprintf( BoxData[10], "%10.3e ", curve_div[3].xy);
			sprintf( BoxData[12], "%10.3e ", curve_div[2].xy);
			sprintf( BoxData[14], "%10.3e ", curve_div[1].xy);
			sprintf( BoxData[16], "%10.3e ", curve_div[0].xy);
		break;
		case 47:
			strncpy(BoxText, "curve I", 7);
			Color_flag[40] = 1;
			strain_flag = 1;
			stress_flag = 0;
			sprintf( BoxData[0], "%10.3e ", curve_div[8].I);
			sprintf( BoxData[2], "%10.3e ", curve_div[7].I);
			sprintf( BoxData[4], "%10.3e ", curve_div[6].I);
			sprintf( BoxData[6], "%10.3e ", curve_div[5].I);
			sprintf( BoxData[8], "%10.3e ", curve_div[4].I);
			sprintf( BoxData[10], "%10.3e ", curve_div[3].I);
			sprintf( BoxData[12], "%10.3e ", curve_div[2].I);
			sprintf( BoxData[14], "%10.3e ", curve_div[1].I);
			sprintf( BoxData[16], "%10.3e ", curve_div[0].I);
		break;
		case 48:
			strncpy(BoxText, "curve II", 8);
			Color_flag[41] = 1;
			strain_flag = 1;
			stress_flag = 0;
			sprintf( BoxData[0], "%10.3e ", curve_div[8].II);
			sprintf( BoxData[2], "%10.3e ", curve_div[7].II);
			sprintf( BoxData[4], "%10.3e ", curve_div[6].II);
			sprintf( BoxData[6], "%10.3e ", curve_div[5].II);
			sprintf( BoxData[8], "%10.3e ", curve_div[4].II);
			sprintf( BoxData[10], "%10.3e ", curve_div[3].II);
			sprintf( BoxData[12], "%10.3e ", curve_div[2].II);
			sprintf( BoxData[14], "%10.3e ", curve_div[1].II);
			sprintf( BoxData[16], "%10.3e ", curve_div[0].II);
		break;
		case 1:
		...
		break;
		case 53:
			strncpy(BoxText, "moment XY", 9);
			Color_flag[31] = 1;
			strain_flag = 0;
			stress_flag = 1;
			sprintf( BoxData[0], "%10.3e ", moment_div[8].xy);
			sprintf( BoxData[2], "%10.3e ", moment_div[7].xy);
			sprintf( BoxData[4], "%10.3e ", moment_div[6].xy);
			sprintf( BoxData[6], "%10.3e ", moment_div[5].xy);
			sprintf( BoxData[8], "%10.3e ", moment_div[4].xy);
			sprintf( BoxData[10], "%10.3e ", moment_div[3].xy);
			sprintf( BoxData[12], "%10.3e ", moment_div[2].xy);
			sprintf( BoxData[14], "%10.3e ", moment_div[1].xy);
			sprintf( BoxData[16], "%10.3e ", moment_div[0].xy);
		break;
		case 56:
			strncpy(BoxText, "moment I", 8);
			Color_flag[40] = 1;
			strain_flag = 0;
			stress_flag = 1;
			sprintf( BoxData[0], "%10.3e ", moment_div[8].I);
			sprintf( BoxData[2], "%10.3e ", moment_div[7].I);
			sprintf( BoxData[4], "%10.3e ", moment_div[6].I);
			sprintf( BoxData[6], "%10.3e ", moment_div[5].I);
			sprintf( BoxData[8], "%10.3e ", moment_div[4].I);
			sprintf( BoxData[10], "%10.3e ", moment_div[3].I);
			sprintf( BoxData[12], "%10.3e ", moment_div[2].I);
			sprintf( BoxData[14], "%10.3e ", moment_div[1].I);
			sprintf( BoxData[16], "%10.3e ", moment_div[0].I);
		break;
		case 57:
			strncpy(BoxText, "moment II", 9);
			Color_flag[41] = 1;
			strain_flag = 0;
			stress_flag = 1;
			sprintf( BoxData[0], "%10.3e ", moment_div[8].II);
			sprintf( BoxData[2], "%10.3e ", moment_div[7].II);
			sprintf( BoxData[4], "%10.3e ", moment_div[6].II);
			sprintf( BoxData[6], "%10.3e ", moment_div[5].II);
			sprintf( BoxData[8], "%10.3e ", moment_div[4].II);
			sprintf( BoxData[10], "%10.3e ", moment_div[3].II);
			sprintf( BoxData[12], "%10.3e ", moment_div[2].II);
			sprintf( BoxData[14], "%10.3e ", moment_div[1].II);
			sprintf( BoxData[16], "%10.3e ", moment_div[0].II);
		break;
		case 10:
		...
		case 32:
			...
			if(flag_quad_element)
			{
			    dum1 = *(connecter + npel4*ele_choice);
			    dum2 = *(connecter + npel4*ele_choice+1);
			    sprintf( BoxData[8], "%4d,%4d ",dum1, dum2);
			    dum1 = *(connecter + npel4*ele_choice+2);
			    dum2 = *(connecter + npel4*ele_choice+3);
			    sprintf( BoxData[10], "%4d,%4d ",dum1, dum2);
			}
			else
			{
			    dum1 = *(connecter + npel3*ele_choice);
			    dum2 = *(connecter + npel3*ele_choice+1);
			    sprintf( BoxData[8], "%4d,%4d ",dum1, dum2);
			    dum1 = *(connecter + npel3*ele_choice+2);
