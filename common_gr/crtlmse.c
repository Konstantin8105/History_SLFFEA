/*
    ...
    brick, tetrahedron, and wedge program.
...
/* Displacement Z*/
	...
	switch (color_choice) {
		...
		break;
		case 3:
			strncpy(BoxText, "strain ZZ", 9);
			Color_flag[31] = 1;
			strain_flag = 1;
			stress_flag = 0;
			sprintf( BoxData[0], "%10.3e ", strain_div[8].zz);
			sprintf( BoxData[2], "%10.3e ", strain_div[7].zz);
			sprintf( BoxData[4], "%10.3e ", strain_div[6].zz);
			sprintf( BoxData[6], "%10.3e ", strain_div[5].zz);
			sprintf( BoxData[8], "%10.3e ", strain_div[4].zz);
			sprintf( BoxData[10], "%10.3e ", strain_div[3].zz);
			sprintf( BoxData[12], "%10.3e ", strain_div[2].zz);
			sprintf( BoxData[14], "%10.3e ", strain_div[1].zz);
			sprintf( BoxData[16], "%10.3e ", strain_div[0].zz);
		break;
		case 4:
		...
		break;
		case 12:
			strncpy(BoxText, "stress ZZ", 9);
			Color_flag[31] = 1;
			strain_flag = 0;
			stress_flag = 1;
			sprintf( BoxData[0], "%10.3e ", stress_div[8].zz);
			sprintf( BoxData[2], "%10.3e ", stress_div[7].zz);
			sprintf( BoxData[4], "%10.3e ", stress_div[6].zz);
			sprintf( BoxData[6], "%10.3e ", stress_div[5].zz);
			sprintf( BoxData[8], "%10.3e ", stress_div[4].zz);
			sprintf( BoxData[10], "%10.3e ", stress_div[3].zz);
			sprintf( BoxData[12], "%10.3e ", stress_div[2].zz);
			sprintf( BoxData[14], "%10.3e ", stress_div[1].zz);
			sprintf( BoxData[16], "%10.3e ", stress_div[0].zz);
		break;
		case 13:
...
#if BRICK2 || TETRA2 || WEDGE2
		case 60:
			strncpy(BoxText, "Temp", 4);
			Color_flag[42] = 1;
			strain_flag = 0;
			stress_flag = 0;
			disp_flag = 0;
			thermal_flag = 1;
			sprintf( BoxData[0], "%10.3e ", T_div[8]);
			sprintf( BoxData[2], "%10.3e ", T_div[7]);
			sprintf( BoxData[4], "%10.3e ", T_div[6]);
			sprintf( BoxData[6], "%10.3e ", T_div[5]);
			sprintf( BoxData[8], "%10.3e ", T_div[4]);
			sprintf( BoxData[10], "%10.3e ", T_div[3]);
			sprintf( BoxData[12], "%10.3e ", T_div[2]);
			sprintf( BoxData[14], "%10.3e ", T_div[1]);
			sprintf( BoxData[16], "%10.3e ", T_div[0]);
		break;
		case 61:
			strncpy(BoxText, "heat Q", 6);
			Color_flag[43] = 1;
			strain_flag = 0;
			stress_flag = 0;
			disp_flag = 0;
			thermal_flag = 2;
			sprintf( BoxData[0], "%10.3e ", Q_div[8]);
			sprintf( BoxData[2], "%10.3e ", Q_div[7]);
			sprintf( BoxData[4], "%10.3e ", Q_div[6]);
			sprintf( BoxData[6], "%10.3e ", Q_div[5]);
			sprintf( BoxData[8], "%10.3e ", Q_div[4]);
			sprintf( BoxData[10], "%10.3e ", Q_div[3]);
			sprintf( BoxData[12], "%10.3e ", Q_div[2]);
			sprintf( BoxData[14], "%10.3e ", Q_div[1]);
			sprintf( BoxData[16], "%10.3e ", Q_div[0]);
		break;
		case 30:
			strncpy(BoxText, "Material", 8);
			Color_flag[5] = 1;
			...
			Material_flag = 1;
			sprintf( BoxData[0], "%4d ", matl_choice);
			strncpy( BoxData[1], "Thrml Con", 9);
			sprintf( BoxData[2], "%10.3e ", matl_crtl[matl_choice].thrml_cond.x);
			sprintf( BoxData[3], "%10.3e ", matl_crtl[matl_choice].thrml_cond.y);
			sprintf( BoxData[4], "%10.3e ", matl_crtl[matl_choice].thrml_cond.z);
			strncpy( BoxData[5], "Thrml Exp", 9);
			sprintf( BoxData[6], "%10.3e ", matl_crtl[matl_choice].thrml_expn.x);
			sprintf( BoxData[7], "%10.3e ", matl_crtl[matl_choice].thrml_expn.y);
			sprintf( BoxData[8], "%10.3e ", matl_crtl[matl_choice].thrml_expn.z);
			strncpy( BoxData[9], "Emod", 4);
			sprintf( BoxData[10], "%10.3e ", matl_crtl[matl_choice].E.x);
			sprintf( BoxData[11], "%10.3e ", matl_crtl[matl_choice].E.y);
			sprintf( BoxData[12], "%10.3e ", matl_crtl[matl_choice].E.z);
			strncpy( BoxData[13], "Poisson", 7);
			sprintf( BoxData[14], "%10.3e ", matl_crtl[matl_choice].nu.xy);
			sprintf( BoxData[15], "%10.3e ", matl_crtl[matl_choice].nu.xz);
			sprintf( BoxData[16], "%10.3e ", matl_crtl[matl_choice].nu.yz);
		break;
#endif
		case 31:
		...
		case 32:
			...
			dum1 = *(connecter + npel*ele_choice+4);
			dum2 = *(connecter + npel*ele_choice+5);
			sprintf( BoxData[12], "%4d,%4d ",dum1, dum2);
			dum1 = *(connecter + npel*ele_choice+6);
			dum2 = *(connecter + npel*ele_choice+7);
			sprintf( BoxData[14], "%4d,%4d ",dum1, dum2);
			sprintf( BoxData[16], " ");
#endif
#if TETRA1
			sprintf( BoxData[10], "%4d,%4d ",dum1, dum2);
