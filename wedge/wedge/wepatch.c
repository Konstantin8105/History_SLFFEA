/*
    ...
    data set to prepare it for the patch test analysis on a wedge
...
int main(int argc, char** argv)
{
	...
	double fdum1, fdum2, fdum3, ux[15], uy[15], uz[15];
        char name[30];
	char buf[ BUFSIZ ];
        FILE *o1, *o2;
	char text;
	   ...
	   *(uz+i) = 0.041*fdum1 + 0.033*fdum2 - 0.027*fdum3;
        ...
        fprintf( o2, "\n\n\n Note: Remove the prescribed displacements for node 5.\n");
        fprintf( o2, "%4d %14.6e\n",5,*(ux+5));
        fprintf( o2, "%4d %14.6e\n",5,*(uy+5));
        fprintf( o2, "%4d %14.6e\n",5,*(uz+5));
        return 1;
