/*
    ...
    the wedge finite element program.
...
int weMemory( double **mem_double, int sofmf, int **mem_int, int sofmi,
...
int weReGetMemory( double **mem_double, int sofmf, int **mem_int, int sofmi,
	MATL **matl, int nmat, XYZI **mem_XYZI, int sofmXYZI, SDIM **mem_SDIM,
	int sofmSDIM, STRAIN **strain, STRESS **stress, int sofmSTRESS )
{
/* For the doubles */
