/*
    This is the include file "weconst.h" for the finite element progam 
    which uses wedge elements.  It is set up for all the different
    wedge elements including the thermal.
...
#define npel          6                /* nodes per element */
#define neqel         npel*ndof        /* degrees of freedom per element */
#define num_int       6                /* number of integration points */
...
/*    Below is the additional list of constants for the wedge element we2
...
/*
      Below is a list of variables for the wedge elements we and nwe.  
  ...
  connect      (0-7)  connectivity array for 3-D wedge elements
...
/*
      Below is the additional list of variables for the wedge element we2
      which has thermal properties.  
