/*
    ...
    the wedge finite element graphics program. 
...
int weMemory_gr( ISTRAIN **strain_color, ISTRESS **stress_color, NORM **mem_NORM,
...
int weMemory2_gr( XYZF **mem_XYZF, int sofmXYZF )
{
...
int weReGetMemory_gr( ISTRAIN **strain_color, ISTRESS **stress_color, NORM **mem_NORM,
	int sofmISTRESS, int sofmNORM )
{
...
int weReGetMemory2_gr( XYZF **mem_XYZF, int sofmXYZF )
{
