...
void wedisp_vectors0(int displaylistnum, BOUND bc, double *coord0)
{
...
void weforce_vectors0(int displaylistnum, BOUND bc, double *coord0,
	XYZF *force_vec )
{
...
void wedisp_vectors(BOUND bc, double *coord)
{
...
void weforce_vectors(BOUND bc, double *coord, XYZF *force_vec )
{
