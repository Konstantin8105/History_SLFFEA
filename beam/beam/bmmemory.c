/*
    ...
    the beam finite element program.
...
int bmMemory( double **mem_double, int sofmf, int **mem_int, int sofmi, MATL **matl,
	int nmat, XYZPhiI **mem_XYZPhiI, int sofmXYZPhiI, CURVATURE **curve,
	MOMENT **moment, STRAIN **strain, STRESS **stress, int sofmSTRESS )
{
/* For the doubles */
...
int bmReGetMemory( double **mem_double, int sofmf, int **mem_int, int sofmi,
	MATL **matl, int nmat, XYZPhiI **mem_XYZPhiI, int sofmXYZPhiI,
	CURVATURE **curve, MOMENT **moment, STRAIN **strain, STRESS **stress,
	int sofmSTRESS )
{
/* For the doubles */
